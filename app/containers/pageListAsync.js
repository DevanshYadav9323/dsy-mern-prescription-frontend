...
export const OtpVerification = loadable(() =>
  import('./Pages/Otp/OtpVerification'), {
  fallback: <Loading />,
});
export const Earnings = loadable(() =>
  import('./Pages/Earnings/Earning'), {
  fallback: <Loading />,
});
export const Settlements = loadable(() =>
  import('./Pages/Settlements/Settlement'), {
  fallback: <Loading />,
});